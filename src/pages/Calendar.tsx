  ...
  return (
    <div className="flex-1 flex bg-[#FAFAFA] overflow-hidden">
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        {/* Heatmap section */}
        <div className="bg-white mx-4 mt-3 rounded-lg border border-[#E5E7EB] shadow-[0_1px_2px_rgba(0,0,0,0.04)] p-4 shrink-0">
          <div className="flex items-center justify-between mb-3">
            <p className="text-[11px] font-semibold text-[#9CA3AF] tracking-wider">{todayYear} Activity</p>
            <div className="flex items-center gap-3 text-[10px] text-[#6B7280]">
              <div className="flex items-center gap-1.5"><div className="w-2.5 h-2.5 rounded-sm border border-[#D1D5DB] bg-[#EF4444]" /> Task</div>
              <div className="flex items-center gap-1.5"><div className="w-2.5 h-2.5 rounded-sm border border-[#D1D5DB] bg-[#D97706]" /> Event</div>
              <div className="flex items-center gap-1.5"><div className="w-2.5 h-2.5 rounded-sm border border-[#D1D5DB] bg-[#2878D9]" /> Session</div>
            </div>
          </div>
